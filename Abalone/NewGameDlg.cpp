...
void NewGameDlg::DoDataExchange(CDataExchange* pDX)
{
  ...
  DDX_Control(pDX, IDC_CHECK_KILLER_MOVES1, myCheckPlayer1KillerMoves);
  DDX_Control(pDX, IDC_CHECK_KILLER_MOVES2, myCheckPlayer2KillerMoves);
...
BOOL NewGameDlg::OnInitDialog()
{
  ...
  myCheckPlayer1KillerMoves.SetCheck(BST_CHECKED);
  myCheckPlayer2KillerMoves.SetCheck(BST_CHECKED);
  myCheckPlayer1KillerMoves.EnableWindow(FALSE);
  myCheckPlayer2KillerMoves.EnableWindow(FALSE);
...
void NewGameDlg::OnOK()
{
  ...
  if (typePlayer1 == Player::PLAYER_TYPE_COMPUTER_MONTE_CARLO) {
    ...
    abPlayer->SetUseKillerMoves(myCheckPlayer1KillerMoves.GetCheck() == BST_CHECKED);
  ...
  if (typePlayer2 == Player::PLAYER_TYPE_COMPUTER_MONTE_CARLO) {
    ...
    abPlayer->SetUseKillerMoves(myCheckPlayer2KillerMoves.GetCheck() == BST_CHECKED);
...
void NewGameDlg::OnRadioPlayer1Changed()
{
  ...
  if (radioTypePlayer1 == IDC_RADIO_COMPUTER_ALPHA_BETA_PLAYER1) {
    ...
    myCheckPlayer1KillerMoves.EnableWindow(TRUE);
...
void NewGameDlg::OnRadioPlayer2Changed()
{
  ...
  if (radioTypePlayer2 == IDC_RADIO_COMPUTER_ALPHA_BETA_PLAYER2) {
    ...
    myCheckPlayer2KillerMoves.EnableWindow(TRUE);
